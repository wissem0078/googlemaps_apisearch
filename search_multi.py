...
def main():
    ...
    parser.add_argument("--api_key", required=True, help="Dein Google Maps API-Key")
    parser.add_argument("--lat",     type=float, required=True, help="Zentralpunkt Breitengrad")
    parser.add_argument("--lng",     type=float, required=True, help="Zentralpunkt Längengrad")
    parser.add_argument("--radius",  type=int,   default=35000,    help="Radius in Metern")
    parser.add_argument(
        "--queries", required=True,
        help="Komma-separierte Suchbegriffe, z.B. coach,Arzt,Trainer"
    )
    parser.add_argument(
    ...
    for query in queries:
        ...
        for p in places:
            ...
            # Optional: Steuerberater rausfiltern
            if "steuerberater" in name.lower():
                continue
